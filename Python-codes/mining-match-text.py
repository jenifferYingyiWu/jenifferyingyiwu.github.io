def string_matching_native(text='', pattern=''):
    ...
    Example: text = 'ababbababa', pattern = 'aba'
                    string_matching_native(t, s) returns [0, 5, 7]
...
def reverse_string_words(s):
    """Reverse words inside a string (in place).
     ...
     Since strings are immutable in Python, we copy the string charts to a list first.
